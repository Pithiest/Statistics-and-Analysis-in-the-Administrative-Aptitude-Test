  ...
  return (
    <ResponsiveContainer>
      <AreaChart data={data}>
        ...
        <Line yAxisId="right" type="monotone" dataKey="rate" name="正确率" stroke="#0f766e" strokeWidth={2.4} dot={false} connectNulls isAnimationActive={false} />
        <Line yAxisId="right" type="monotone" dataKey="pace" name="配速" stroke="#b45309" strokeWidth={2} dot={false} strokeDasharray="5 5" connectNulls isAnimationActive={false} />
      </AreaChart>
    </ResponsiveContainer>
  );
}
  ...
  return (
    <ResponsiveContainer>
      <RadarChart data={data}>
        ...
        <Radar dataKey="正确率" stroke="#2563eb" fill="#2563eb" fillOpacity={0.24} isAnimationActive={false} />
        <Tooltip formatter={chartFormatter} />
      </RadarChart>
    </ResponsiveContainer>
  );
  ...
  return (
    <ResponsiveContainer>
      <LineChart data={data}>
        ...
        <Line yAxisId="left" type="monotone" dataKey="rate" name="正确率" stroke="#2563eb" strokeWidth={2.6} dot={false} connectNulls isAnimationActive={false} />
        <Line yAxisId="right" type="monotone" dataKey="pace" name="配速" stroke="#b45309" strokeWidth={2.2} dot={false} strokeDasharray="5 5" connectNulls isAnimationActive={false} />
      </LineChart>
    </ResponsiveContainer>
  );
}
  ...
  return (
    <ResponsiveContainer>
      <BarChart data={data} layout={vertical ? "vertical" : "horizontal"}>
        ...
        <XAxis type={vertical ? "number" : "category"} dataKey={vertical ? undefined : "name"} tickLine={false} axisLine={false} />
        <YAxis type={vertical ? "category" : "number"} dataKey={vertical ? "name" : undefined} tickLine={false} axisLine={false} width={82} />
        <Tooltip formatter={chartFormatter} />
